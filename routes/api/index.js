...
const playerPointEarnedRoutes = require("./playerPointEarnedRoutes");
const playerPointsEarnedRoutes = require("./playerPointsEarnedRoutes");
const playerHoleRoutes = require("./playerHoleRoutes");
...
router.use("/player-point-earned", playerPointEarnedRoutes);
router.use("/player-points-earned", playerPointsEarnedRoutes);
router.use("/player-hole", playerHoleRoutes);
